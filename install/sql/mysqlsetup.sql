/* ------------------------------------------------------------------------------
        ...
        -- Script to create NixMash Cloud MySQL Schema
        -- Initialization Scripting at bottom supporting WordPress NixMash Spring Migrator
        -- Version v1.0.0
...
-- ----------------------------
-- Initialization scripting for post WordPress Blog Migration to NixMash Blog
-- ----------------------------
...
update posts set post_content = REPLACE(post_content,'http://mysite.com/links/?','#?');
